 ...
 *
 * - '[YouTube API](https://googleapis.dev/java/google-api-services-youtube/latest/com/google/api/services/youtube/model/I18nLanguage.html)
 * - '[Codes for constructed languages](https://en.wikipedia.org/wiki/Codes_for_constructed_languages)
 * - [IETF Language Tag](https://en.wikipedia.org/wiki/IETF_language_tag)
 */
@SuppressWarnings("unused")
public record Language (String code, String hl, String name) {
}
