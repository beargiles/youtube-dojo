...
public class ClientForPlaylistImageListFactory {
    ...
    public ClientForPlaylistImageListFactory(YouTube.Builder ytBuilder) {
    ...
    public static class Builder {
         ...
         * @throws IOException
         */
        public ClientForPlaylistImageList build() throws IOException {
            ...
            return new ClientForPlaylistImageList(request);
        }
    }

    public static class ClientForPlaylistImageList extends ClientForYouTubeRequest<PlaylistImage, PlaylistImageListResponse, com.google.api.services.youtube.model.PlaylistImage> {
        public ClientForPlaylistImageList(YouTube.PlaylistImages.List request) {
            super(new PlaylistImageState(request));
        }
    }


    public static class PlaylistImageState extends AbstractClientState<PlaylistImage, PlaylistImageListResponse, com.google.api.services.youtube.model.PlaylistImage> {
        private final YouTube.PlaylistImages.List request;

        public PlaylistImageState(YouTube.PlaylistImages.List request) {
        ...
        public void update() throws IOException {
            ...
            final PlaylistImageListResponse response = request.execute();
         ...
         * @return
         */
        public PlaylistImage convert(com.google.api.services.youtube.model.PlaylistImage image) {
