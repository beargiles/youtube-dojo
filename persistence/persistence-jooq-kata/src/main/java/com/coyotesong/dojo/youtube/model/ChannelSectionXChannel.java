 ...
 * Join table...
 */
public class ChannelSectionXChannel implements Serializable {
    @Serial
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChannelSectionXChannel that)) return false;
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.JSON_STYLE)
                .append("parentChannelId", parentChannelKey)
                .append("parentPosition", parentPosition)
                .append("channelId", channelKey)
