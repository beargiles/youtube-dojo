...
public class TestJooqProperties {
    ...
    public TestJooqProperties(DataSourceConnectionProvider connectionProvider) {
    ...
    public org.jooq.Configuration jooqConfiguration() {
        ...
        // it looks like this is required even if record and event look the same
        // MyRecordMapperProvider provider = new MyRecordMapperProvider();
        // jooqConfiguration.setRecordMapperProvider(provider);
        // jooqConfiguration.setRecordUnmapperProvider(provider);
    ...
    public DefaultDSLContext dsl() {
        // final DSLContext dsl = new DefaultDSLContext(jooqConfiguration());
