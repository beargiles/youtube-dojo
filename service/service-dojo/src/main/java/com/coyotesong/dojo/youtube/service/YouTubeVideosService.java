 ...
 * - Chart (?)
 * - HL/Locale
 * - MaxWidth [72..8192]/MaxHeight [72..8192]
 * - MyRating
 * - RegionCode
 * - VideoCategoryId
 *
 ...
 *
 * See [YouTube.Videos.List](https://googleapis.dev/java/google-api-services-youtube/latest/index.html?com/google/api/services/youtube/YouTube.Videos.List.html)
 */
