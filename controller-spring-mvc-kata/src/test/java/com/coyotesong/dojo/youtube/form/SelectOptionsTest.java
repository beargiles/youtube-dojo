...
public class SelectOptionsTest {
    ...
    public void Given_LanguageSearchOptions_When_VerifyNotEmpty_Then_Success() {
        assertThat("languagelSelectOptions is empty", SelectOption.LANGUAGE_SELECT_LIST, not(empty()));
    }
    ...
    public void Given_SaveSearchOptions_When_VerifyNotEmpty_Then_Success() {
        assertThat("safeSearchhOptions is empty", SelectOption.SAFE_SEARCH_SELECT_LIST, not(empty()));
    }
}
